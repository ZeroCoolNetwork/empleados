      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li <?php if ($_GET["r"] == "user/index"){ echo 'class="active"'; } ?>><a href="<?php echo ROUTER::create_action_url("user/index") ?>">Home</a></li>
            <li <?php if ($_GET["r"] == "user/login"){ echo 'class="active"'; } ?>><a href="<?php echo ROUTER::create_action_url("user/login") ?>">Login</a></li>
